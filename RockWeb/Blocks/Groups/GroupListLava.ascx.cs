...
namespace RockWeb.Blocks.Groups
{
    ...
    [Category( "Groups" )]
    [Description( "Lists all groups using a Lava template." )]
    ...
    [CodeEditorField( "Lava Template", "The lava template to use to format the group list.", CodeEditorMode.Liquid, CodeEditorTheme.Rock, 400, true, "{% include '~~/Assets/Lava/GroupList.lava' %}", "", 6 )]
    [BooleanField( "Enable Debug", "Shows the fields available to merge in lava.", false, "", 7 )]
    public partial class GroupListLava : RockBlock
    {
        ...
        [DotLiquid.LiquidType( "Group", "GroupType" )]
