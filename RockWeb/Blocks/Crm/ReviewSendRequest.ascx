<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReviewSendRequest.ascx.cs" Inherits="RockWeb.Blocks.Crm.ReviewSendRequest" %>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlForm" runat="server" Visible="true" CssClass="js-send-request">
                    ...
                    <Rock:NumberBox ID="nbUpdatedLessThan" runat="server" CssClass="input-width-sm" Label="Exclude people who have updated their record in the last (months)" Text="6" ></Rock:NumberBox>
